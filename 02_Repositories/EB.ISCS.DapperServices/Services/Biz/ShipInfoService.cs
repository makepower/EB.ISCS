...
namespace EB.ISCS.DapperServices.Repository
{
    ...
    public partial class ShipInfoService : Service, IShipInfoService
    {
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        public bool DeleteById(int id, IDbTransaction transaction = null)
        {
            return this._ShipInfoRepository.DeleteById(id, transaction);
        }
        ...
        /// <summary>
        /// 获取用户所有的Maticsoft.Model.ShipInfo信息
        /// </summary>
        /// <returns></returns>
        public IEnumerable<ShipInfo> GetShipsByUserId(int userid)
        {
            return this._ShipInfoRepository.GetShipsByUserId(userid);
        }
