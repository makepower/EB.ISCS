...
(function () {
    ...
    var app = angular.module('TaskTemplateListApp', ['CommonApp']);
    ...
    var employeeList = {
        ...
        AddEventListener: function () {
            ...
            $("#btn_createform").click(function () {
                ...
                if (gridView.gvIsSelectRow()) {
                    var row = gridView.gvGetSelectRow();
                    window.comControl.openTabpage("TaskTemplate/CreateForm/" + row.Id, "编辑【" + row.Name + "】表单");
                }
            });
            //打开表单创建
            $("#btn_createflow").click(function () {
                ...
                if (gridView.gvIsSelectRow()) {
                    var row = gridView.gvGetSelectRow();
                    window.comControl.openTabpage("TaskTemplate/CreateFlow/" + row.Id, "编辑【" + row.Name + "】流程");
                }
            });
        ...
        showEdit: function (id, title) {
            var _this = this;
            var url = "/TaskTemplate/Edit?id=" + id + "&_t=" + Math.random();
            id = id ? id : 0;
            layer.open({
                type: 2,
                title: title,
    ...
    //控制器
    app.controller("TaskTemplateListController", function ($scope, commonService) {
