    ...
    a.widget("bootstrap.bwizard", {
        ...
        _createButtons: function () {
            ...
            if (!this.buttons) {
                d = h.navButtons;
                var f = false;
                this.buttons = a(".modal-footer");//a('<ul class="pager"/>');
                var br = "<button class='btn btn-default'>" + c + "</button>";
                var bz = "<button class='btn btn-default'>" + g + "</button>";
                if (c != "") {
                    this.backBtn = a(br).appendTo(this.buttons).bind({
                        click: function () {
                            e.back();
                            return false;
                        }
                ...
                if (g != "") {
                    this.nextBtn = a(bz).appendTo(this.buttons).bind({
                        click: function () {
                            e.next();
                            return false;
                        }
