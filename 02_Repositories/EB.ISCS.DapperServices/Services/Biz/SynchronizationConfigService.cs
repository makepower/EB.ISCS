...
namespace EB.ISCS.DapperServices.Repository
{
    ...
    public partial class SynchronizationConfigService : Service, ISynchronizationConfigService
    {
        ...
        {
            return this._SynchronizationConfigRepository.DeleteByKey(model.Id, transaction);
        }
        ...
        /// </summary>
        /// <returns></returns>
        public SynchronizationConfig GetByUserId(int userId)
        {
            return this._SynchronizationConfigRepository.GetByUserId(userId);
        }
    }
}