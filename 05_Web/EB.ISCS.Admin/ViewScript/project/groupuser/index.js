...
(function () {
    ...
    var list = {
        ...
        InitGrid: function () {
            var _this = this;
            gridView.gvLoadGrid({
                gvHeadXml: "Project\\组成员管理",
                gvUrl: "/GroupUser/GetList",
        ...
        AddEventListener: function () {
            ...
            $("#btn_del").click(function () {
                ...
                gridView.tgvDeleteRowsUrl(
                    "/GroupUser/DelData/" + row.Id,// 删除url
                    function () {
        ...
        showEdit: function (id, title) {
            var _this = this;
            var url = "/GroupUser/Edit?id=" + id + "&_t=" + Math.random();
            id = id ? id : 0;
            layer.open({
                type: 2,
                title: title,
