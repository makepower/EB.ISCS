...
(function () {
    ...
    var app = angular.module('DiscreteTaskListApp', ['CommonApp']);
    ...
    var employeeList = {
        ...
        InitGrid: function () {
            var _this = this;
            gridView.gvLoadGrid({
                gvHeadXml: "Task\\离散任务列表",
                gvUrl: "/TaskDiscreteEx/ExList",
        ...
        AddEventListener: function () {
            ...
            $("#btn_del").click(function () {
                ...
                if (row.Id) {
                    $.post("/TaskDiscreteEx/FormDelete/" + row.Id, function (result) {
            ...
            $("#btn_create").click(function () {
                ...
                if (gridView.gvIsSelectRow()) {
                    ...
                    var layerFr = layer.open({
                        ...
                        area: ["1100px", he + "px"],
                        content: ["/TaskDiscreteEx/CreateForm/" + row.Id, "no"]
                    });
                    layer.full(layerFr);
                }
            });
        ...
        showEdit: function (id, title) {
            var _this = this;
            var url = "/TaskDiscreteEx/Edit?id=" + id + "&_t=" + Math.random();
            id = id ? id : 0;
            layer.open({
                type: 2,
                title: title,
    ...
    //控制器
    app.controller('DiscreteTaskListController', function ($scope, commonService) {
