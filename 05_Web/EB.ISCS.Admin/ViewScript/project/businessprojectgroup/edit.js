    ...
    app.factory("service", ["$http", function ($http) {
        return {
            ...
            getModel: function (id) {
                return $http.post("/BusinessProjectGroup/GetModelById", { 'Id': id });
            },
            //保存数据
            setModel: function (data) {
                return $http.post("/BusinessProjectGroup/SaveModel", data);
            }
        }
    }]);
    ...
    var model = {
        ...
        AddEventListener: function () {
            ...
            _scope.onSave = function () {
                _scope.model.GroupType = comControl.comboxTree.getTreeValue("GroupType");
                _scope.model.ProjectId = $("#project").combobox("getValue");
                if (!_scope.model.GroupType || _scope.model.GroupType == "0") {
                    layer.msg("请先选择类型！");
                } else {
