...
(function () {
    ...
    var projectList = {
        ...
        InitGrid: function () {
            var _this = this;
            gridView.gvLoadGrid({
                gvHeadXml: "Project\\项目阶段详情管理",
                gvUrl: "/BusinessProjectStageInfo/GetList",
        ...
        AddEventListener: function () {
            ...
            $('#btn_edit').click(function () {
                if (gridView.gvIsSelectRow()) {
                    ...
                    _this.showEdit(row.Id, "编辑项目阶段详情");
                }
            });
            ...
            $("#btn_del").click(function () {
                ...
                gridView.tgvDeleteRowsUrl(
                    "/BusinessProjectStageInfo/DelData/" + row.Id,// 删除url
                    function () {
        ...
        showEdit: function (id, title) {
            var _this = this;
            var url = "/BusinessProjectStageInfo/Edit?id=" + id + "&_t=" + Math.random();
            id = id ? id : 0;
            layer.open({
                type: 2,
                title: title,
