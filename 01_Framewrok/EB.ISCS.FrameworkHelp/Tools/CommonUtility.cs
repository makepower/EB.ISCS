...
namespace EB.ISCS.FrameworkHelp.Utilities
{
    public class CommonUtility
    {
        ...
        /// <returns></returns>
        public static string SerializeToBinary(object serialObject)
        {
            string result;
        ...
        public static string GetMethodArgumentValue(object[] arguments)
        {
            ...
            for (int i = 0; i < arguments.Length; i++)
            {
                if (arguments[i] != null)
                {
                    ...
                    {
                        result += CommonUtility.SerializeToXml(arguments[i]);
                    }
        ...
        public static void WriteEventLog(string source, string content, EventLogEntryType type)
        {
            try
            {
                ...
                {
                    EventLog.CreateEventSource(source, "Sea2soft Log");
                }
