...
(function () {
    ...
    app.factory("service", ["$http", function ($http) {
        return {
            ...
            saveData: function (d) {
                console.info(d);
                //return $http.post("/BusinessProjectStageTask/AddEntities?id=" + d.id + "&flowRules=" + d.flowRules);
                return $http.post("/BusinessProjectStageTask/AddEntities", d);
            }
        }
    }]);
    var model = {
        ...
        InitializePage: function (scope, service, commonService) {
            ...
            gridView = $("#jqGrid");
            where = " and ProjectStageId=" + $("#hidId").val();
        ...
        InitGrid: function () {
            var _this = this;
            gridView.gvLoadGrid({
                gvHeadXml: "Project\\项目阶段任务管理",
                gvUrl: "/BusinessProjectStageTask/GetList",
        ...
        AddEventListener: function () {
            ...
            $('#btn_add').click(function () {
                comControl.selectRules(function () {
                    ...
                    if (data) {
                        ...
                        //$.post({
                        //    url: "/BusinessProjectStageTask/AddEntities",
            ...
            $("#btn_del").click(function () {
                ...
                gridView.tgvDeleteRowsUrl("/BusinessProjectStageTask/DelData/" + row.Id, // 删除url
                    function () {
                        gridView.gvRefreshGrid(where);
                    }
                );
        ...
        showEdit: function (id, title) {
            var _this = this;
            var url = "/BusinessProjectStageTask/Edit?id=" + id + "&_t=" + Math.random();
            id = id ? id : 0;
            parent.layer.open({
                type: 2,
                title: title,
