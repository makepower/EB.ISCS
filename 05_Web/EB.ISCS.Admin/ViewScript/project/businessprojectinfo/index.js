...
(function () {
    ...
    var projectList = {
        ...
        InitGrid: function () {
            var _this = this;
            gridView.gvLoadGrid({
                gvHeadXml: "Project\\项目详情管理",
                gvUrl: "/BusinessProjectInfo/GetList",
        ...
        AddEventListener: function () {
            ...
            $("#btn_del").click(function () {
                ...
                gridView.tgvDeleteRowsUrl(
                    "/BusinessProjectInfo/DelData/" + row.Id,// 删除url
                    function () {
        ...
        showEdit: function (id, title) {
            var _this = this;
            var url = "/BusinessProjectInfo/Edit?id=" + id + "&_t=" + Math.random();
            id = id ? id : 0;
            layer.open({
                type: 2,
                title: title,
