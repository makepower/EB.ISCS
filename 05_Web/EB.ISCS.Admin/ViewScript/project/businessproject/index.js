...
(function () {
    ...
    var projectList = {
        ...
        InitGrid: function () {
            var _this = this;
            gridView.gvLoadGrid({
                gvHeadXml: "Project\\项目管理",
                gvUrl: "/BusinessProject/GetList",
        ...
        AddEventListener: function () {
            ...
            //    _this.showEditDetail(row.Id, "新增项目详情");
            //});
            ...
            //    }
            //    var row = gridView.gvGetSelectRow();
            //    _this.showEditDetail(row.Id, "编辑项目详情");
            //});

            //$('#btn_check_detail').click(function () {
            //    if (!gridView.gvIsSelectRow()) {
            //        layer.alert("请先选择项目!");
            //        return;
            //    }
            //    var row = gridView.gvGetSelectRow();
            //    _this.showEditDetail(row.Id, "查看项目详情");
            //});
            ...
            $("#btn_del").click(function () {
                ...
                gridView.tgvDeleteRowsUrl(
                    "/BusinessProject/DelData/" + row.Id,// 删除url
                    function () {
            ...
            $('#btn_task').click(function () {
                if (gridView.gvIsSelectRow()) {
                    var row = gridView.gvGetSelectRow();
                    _this.showTaskEdit(row.Id, "编辑项目任务信息");
                }
            });
        },
        ...
        showEdit: function (id, title) {
            var _this = this;
            var url = "/BusinessProject/Edit?id=" + id + "&_t=" + Math.random();
            id = id ? id : 0;
            layer.open({
                type: 2,
                title: title,
        ...
        showEditDetail: function (id, title) {
            var _this = this;
            var url = "/BusinessProject/Edit?id=" + id + "&_t=" + Math.random();
            id = id ? id : 0;
            layer.open({
        ...
        showTaskEdit: function (id, title) {
            var _this = this;
            var url = "/BusinessProject/EditTask?id=" + id + "&_t=" + Math.random();
            id = id ? id : 0;
            layer.open({
                type: 2,
                title: title,
