    ...
    public class NamespaceHttpControllerSelector : IHttpControllerSelector
    {
        ...
        private Dictionary<string, HttpControllerDescriptor> InitializeControllerDictionary()
        {
            ...
            foreach (Type t in controllerTypes)
            {
                ...
                //var aa = t.Namespace.Substring(t.Namespace.IndexOf("Controllers.")+12);
                var key = String.Format(CultureInfo.InvariantCulture, "{0}.{1}", segments[segments.Length - 1], controllerName);
                //if (t.Namespace.IndexOf("Controllers.V") >= 0)
                //{
                //    var version = t.Namespace.Substring(t.Namespace.IndexOf("Controllers.V") + 12, 3);
                //    var spacename = t.Namespace.Substring(t.Namespace.IndexOf("Controllers.") + 16);
                // }
